                ...
                <div class="navbar-top d-lg-flex justify-content-between">
                    ...
                    <div class="navbar-top-left">
                        <ul class="navbar-top-link">
                            <li><a href="about-page.html">{{__('msg.about')}}</a></li>
                            <li><a href="contact-page.html">{{__('msg.contact')}}</a></li>
                            <li>
                    ...
                    <div class="navbar-top-right">
                        <ul class="navbar-top-link">
                            ...
                            <li>
                                <form action="{{ route('swap-lang') }}" method="POST">
                                    @csrf
                            ...
                            $user_id = $user->id;
                            @endphp
                            <li><a href="{{ route('users.create' , compact('user_id' )) }}"><i class="mdi mdi-account"></i>{{ $user->name }}</a></li>
                            <li><img src="{{$imageUrl = $user->getFirstMediaUrl('images') ; }}"><</li>
                            @else
                            <li><a href={{ route('login') }}><i class="mdi mdi-account"></i>Login</a></li>
                            @endauth
                ...
                <nav class="main-navbar d-lg-flex justify-content-between align-items-center">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    @php
                                        $user_id = $user->id;
                                    @endphp
                                    <li><a href={{ route('users.create' , compact('user_id' )) }} >Account Page</a></li>
                                    ...
                                    @else
                                    <li><a href="{{ route('login') }}">Log In Page</a></li>
                                    @endauth
                    ...
                    <div class="navbar-search-cart d-none d-lg-flex">
                        ...
                        <div class="navbar-search search-style-5">
                            <div class="search-select">
                                ...
                                @php
                                    ...
                                    @endphp
                                <form method="GET" action="{{ route('products_search' , compact('language')) }}">
                            ...
                            <div class="search-input">
                                <form action="{{ route('products_search') }}">
                        ...
                        <div class="navbar-cart">
                            ...
                            @endphp
                            @if($itemCount)
                                <span class="icon-text text-style-1">{{ $itemCount }}</span>
                                @else
                                                ...
                                                <tr>
                                                    <td class="checkout-product">
                                                        <div class="product-cart d-flex">
                                                            ...
                                                            <div class="product-content media-body">
                                                                <h5 class="title">
                                                                    <a href="product-details-page.html">{{ $cartItem->name }}</a>
                                                                </h5>
                                                                <ul>

                                                                    <li><span>{{ $cartItem->name }}</span></li>
                                                                    <li>
                                                                        <form action="{{ route('cart.remove', ['product' => $cartItem->id]) }}" method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
