        ...
        <div class="col-lg-8 d-flex align-items-strech">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    @endforeach
                    @endif
                    <form action="{{ route('value_option.store') }}" method="Post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div>
                            ...
                            <select name="option_id" class="form-select form-select-sm" aria-label=".form-select-sm example"required>
                                <option value="-1" selected disabled>{{ __('locale.SelectOption') }}</option>
                        ...
                        <div>
                            <label for="exampleFormControlInput1" class="form-label">{{ __('locale.SelectProduct') }}:</label>
                            <select name="product_id" class="form-select form-select-sm" aria-label=".form-select-sm example"required >
                                <option value="-1" selected disabled>{{ __('locale.SelectProduct') }}</option>
